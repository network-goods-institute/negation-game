...
YOU ARE ALWAYS WORKING IN PROD, DO NOT ADD COMMENTS OR MAKE ASSUMPTIONS ABOUT RUNNING IN DEV, ALWAYS PREPARE FOR PRODUCTION. NEGATION GAME IS HOSTED ON VERCEL, SO EVERYTHING YOU DO MUST BE ABLE TO WORK PROPERLY ON VERCEL.
