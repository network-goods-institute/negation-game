    ...
    async () =>
      ...
      WITH point_data AS (
        SELECT
          ...
          COALESCE(SUM(CASE WHEN r.user_id = ${userId}::TEXT THEN er.slashed_amount ELSE 0 END), 0) as "slashedAmount",
          COALESCE(SUM(CASE WHEN d.user_id = ${userId}::TEXT THEN d.amount ELSE 0 END), 0) as "doubtedAmount",
      ...
      doubt_data AS (
        SELECT 
          ...
          COALESCE(SUM(CASE WHEN d.user_id = ${userId}::TEXT THEN d.amount ELSE 0 END), 0) as "userAmount",
