...
interface EdgeVotingProps {
  edgeId: string;
  votes?: Array<string | { id: string; name?: string; avatarUrl?: string }>;
  onToggleVote?: (edgeId: string, userId: string, username?: string) => void;
  variant?: "blue" | "orange";
}
...
export const EdgeVoting: React.FC<EdgeVotingProps> = ({
  edgeId,
  votes = [],
  onToggleVote,
  variant = "blue",
  ...
  const handleClick = (event: React.MouseEvent) => {
    ...
    if (!userId) return;
    onToggleVote?.(edgeId, userId, username);
  };
