  ...
  return (
    <>
      ...
      <div
        ...
        className={`px-4 py-3 rounded-lg bg-white border-2 border-stone-200 inline-block min-w-[200px] max-w-[320px] relative ${locked ? 'cursor-not-allowed' : 'cursor-text'} ${isConnectingFromNodeId === id ? 'ring-2 ring-blue-500 ring-offset-2 ring-offset-white shadow-md' : ''}`}
      >
