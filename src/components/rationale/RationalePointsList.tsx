...
import RationalePointCardWrapper from '../cards/RationalePointCardWrapper';
import { cn } from '@/lib/utils/cn';

export interface RationalePointsListProps {
    points: { pointId: number; parentId?: number | string; initialPointData?: import('@/queries/points/usePointData').PointData }[];
