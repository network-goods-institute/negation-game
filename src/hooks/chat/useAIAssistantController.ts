...
import { useAssistantInitializer } from "@/hooks/chat/useAssistantInitializer";
import { useChatImporter } from "@/hooks/chat/useChatImporter";
...
import { useDiscourseIntegration } from "../data/useDiscourseIntegration";
import type { ChatSidebarProps } from "@/components/chatbot/header/ChatSidebar";
import type { ChatHeaderProps } from "@/components/chatbot/header/ChatHeader";
import type { AIAssistantChatProps } from "@/components/chatbot/ai/AIAssistantChat";
import type { AIAssistantRationaleProps } from "@/components/chatbot/ai/AIAssistantRationale";
...
export function useAIAssistantController() {
  ...
  const rationaleProps: AIAssistantRationaleProps = {
    ...
    onGraphChange: (
      newGraph: ViewpointGraph | null | undefined,
      immediateSave: boolean | undefined
    ) => {
      if (currentChatId) {
        chatList.updateChat(
          currentChatId,
