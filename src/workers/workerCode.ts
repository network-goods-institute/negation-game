// This file exports the worker code as a string to be used with Blob-based workers
// This avoids Next.js issues with direct worker imports

export const getWorkerCode = (): string => {
  return `
    self.onmessage = function(e) {
      ...
      try {
        ...
        if (!Array.isArray(points) || !userId) {
          self.postMessage({ type: "ERROR", message: "Invalid data provided to worker" });
          return;
        }
